...
Main.__name__ = true;
Main.main = function() {
	var page = new components_Page({ route : "/", child : new components_Column({ style : new utils_Style({ color : -1}), padding : utils_Padding.all(10), children : [new components_Row({ children : [new components_Text("Row"),new components_Text("Row"),new components_Text("Row")]}),new components_Text("Hello"),new components_Text("Hello",{ style : new utils_Style({ color : -65281})}),new components_Button({ text : "Click me", onClick : function(e) {
		console.log("src/Main.hx:44:","Clicked");
	}})]})});
