...
com_akifox_asynchttp_AsyncHttp.log = function(message,fingerprint) {
	...
	if(com_akifox_asynchttp_AsyncHttp.logEnabled) {
		console.log("com/akifox/asynchttp/AsyncHttp.hx:98:","${fingerprint} INFO:${message}");
	}
	return message;
};
com_akifox_asynchttp_AsyncHttp.error = function(message,fingerprint,throwError) {
	...
	if(com_akifox_asynchttp_AsyncHttp.logErrorEnabled) {
		console.log("com/akifox/asynchttp/AsyncHttp.hx:98:","${fingerprint} ERROR:${message}");
	}
	if(throwError) {
...
pages_WidgetPage.prototype = $extend(lib_core_DynamicComponent.prototype,{
	...
	,getWidgetDoc: function() {
		...
		new lib_core_SingleRequest({ url : "http://localhost:3000/api/widgets/" + lib_core_Navigate.getParameters()[0] + "/" + lib_core_Navigate.getParameters()[1], method : "GET", onComplete : function(res) {
			_gthis.setState(_gthis,function() {
				...
				console.log("src/pages/WidgetPage.hx:94:",widgetStruct.example);
				var exampleDocs = [];
				var _g2 = 0;
				...
				console.log("src/pages/WidgetPage.hx:116:",_gthis.data.getExample());
			});
		}, onProgress : function() {
			_gthis.setState(_gthis,function() {
				_gthis.data = null;
	...
	,determineCorrectArgumentWidget: function(argument) {
		...
		if(argument.getReq()) {
			...
			var child2 = new lib_utils_Size({ width : 100, widthType : "px"});
			var child3 = " - " + argument.getName();
			var this1 = Std.parseInt("0xff" + HxOverrides.substr("#272727",1,null));
			var child4 = new lib_components_Container({ size : child2, child : new lib_components_Text(child3,{ textSize : 16, color : new lib_utils_Color({ color : this1}), font : "monaco,Consolas,Lucida Console,monospace"})});
			var child5 = new lib_utils_Size({ width : 100, widthType : "px"});
			var child6 = "(" + argument.getType() + ")";
			var this11 = Std.parseInt("0xff" + HxOverrides.substr("#272727",1,null));
			var child7 = new lib_components_Container({ size : child5, child : new lib_components_Text(child6,{ textSize : 16, color : new lib_utils_Color({ color : this11}), font : "monaco,Consolas,Lucida Console,monospace"})});
			var child8 = " : " + argument.getNote();
			var this12 = Std.parseInt("0xff" + HxOverrides.substr("#272727",1,null));
			child = new lib_components_Row({ equalElementWidth : false, alignment : lib_components_RowAlignment.Left, cellSize : child1, children : [child4,child7,new lib_components_Container({ child : new lib_components_Text(child8,{ textSize : 16, color : new lib_utils_Color({ color : this12}), font : "monaco,Consolas,Lucida Console,monospace"})})]});
		} else {
			var child9 = new lib_utils_Size({ width : 100, widthType : "px"});
			var child10 = " - " + argument.getName();
			var this13 = Std.parseInt("0xff" + HxOverrides.substr("#808080",1,null));
			var child11 = new lib_components_Container({ size : child9, child : new lib_components_Text(child10,{ textSize : 16, color : new lib_utils_Color({ color : this13}), font : "monaco,Consolas,Lucida Console,monospace"})});
			...
			var child14 = new lib_components_Container({ size : child12, child : new lib_components_Text(child13,{ textSize : 16, color : new lib_utils_Color({ color : this14}), font : "monaco,Consolas,Lucida Console,monospace"})});
			var child15 = " : " + argument.getNote();
			var this15 = Std.parseInt("0xff" + HxOverrides.substr("#808080",1,null));
			child = new lib_components_Row({ alignment : lib_components_RowAlignment.Left, equalElementWidth : false, children : [child11,child14,new lib_components_Container({ child : new lib_components_Text(child15,{ textSize : 16, color : new lib_utils_Color({ color : this15}), font : "monaco,Consolas,Lucida Console,monospace"})})]});
		}
	...
	,determineCorrectExampleWidget: function(example) {
		console.log("src/pages/WidgetPage.hx:198:","Running");
		if(this.data == null) {
			return null;
		}
		var child = new lib_utils_Size({ width : 120, widthType : "px"});
		var child1 = new lib_utils_Size({ width : 100, widthType : "px"});
		var child2 = " - " + example.getDesc();
		var this1 = Std.parseInt("0xff" + HxOverrides.substr("#272727",1,null));
		var child3 = new lib_components_Row({ equalElementWidth : false, alignment : lib_components_RowAlignment.Left, cellSize : child, children : [new lib_components_Container({ size : child1, child : new lib_components_Text(child2,{ textSize : 16, color : new lib_utils_Color({ color : this1}), font : "monaco,Consolas,Lucida Console,monospace"})}),new lib_components_Container({ size : new lib_utils_Size({ width : 100, widthType : "px"}), child : new lib_components_Request({ jsonp : true, url : "https://gist.github.com/ljellevo/7cbac37d851ce59a45ca45ce6c01fefd.json", onComplete : function(response) {
			var res = response;
			return new lib_components_HtmlSnippet({ snippet : res.div});
		}, onProgress : function() {
			return new lib_components_Text("loading gist");
		}})})]});
		return new lib_components_Container({ padding : lib_utils_Padding.fromTRBL(0.0,25.0,0.0,25.0), child : child3});
	}
	,component: function() {
		var _gthis = this;
		var tmp = new CustomNavbar().navbarComponent();
		...
		var tmp3 = lib_utils_Margin.fromTRBL(60.0,0.0,0.0,0.0);
		var tmp4 = new lib_utils_Size({ height : 5, heightType : "px", width : 60, widthType : "%"});
		var this11 = Std.parseInt("0xff" + HxOverrides.substr("#2e3440",1,null));
		var tmp5 = new lib_components_Container({ margin : tmp3, size : tmp4, color : new lib_utils_Color({ backgroundColor : this11})});
		var tmp6 = lib_utils_Padding.fromTRBL(50.0,50.0,0.0,50.0);
		var tmp7 = this.data != null ? this.data.getName() : "";
		var this12 = Std.parseInt("0xff" + HxOverrides.substr("#2e3440",1,null));
		var tmp8 = new lib_components_Container({ child : new lib_components_Text(tmp7,{ textSize : 40, color : new lib_utils_Color({ color : this12})}), padding : lib_utils_Padding.fromTRBL(0.0,0.0,0.0,0.0)});
		var tmp9 = this.data != null ? " - " + this.data.getCategory() + " - " : "";
		var this13 = Std.parseInt("0xff" + HxOverrides.substr("#808080",1,null));
		var tmp10 = new lib_components_Container({ child : new lib_components_Text(tmp9,{ color : new lib_utils_Color({ color : this13})}), padding : lib_utils_Padding.fromTRBL(0.0,0.0,0.0,20.0)});
		var tmp11 = this.data != null ? this.data.getDesc() : "";
		var this14 = Std.parseInt("0xff" + HxOverrides.substr("#2e3440",1,null));
		var tmp12 = new lib_components_Container({ child : new lib_components_Text(tmp11,{ color : new lib_utils_Color({ color : this14})}), padding : lib_utils_Padding.fromTRBL(20.0,0.0,20.0,0.0)});
		var tmp13 = lib_utils_Padding.fromTRBL(20.0,0.0,20.0,0.0);
		var tmp14 = lib_utils_Margin.fromTRBL(20.0,0.0,20.0,0.0);
		var tmp15 = new lib_utils_Size({ width : 700, widthType : "px"});
		var this15 = Std.parseInt("0xff" + HxOverrides.substr("#F2F2F2",1,null));
		var tmp16 = new lib_components_Container({ padding : tmp13, margin : tmp14, size : tmp15, color : new lib_utils_Color({ backgroundColor : this15}), child : new lib_components_Column({ padding : lib_utils_Padding.fromTRBL(0.0,0.0,0.0,0.0), children : lib_components_Constructors.constructRows({ data : this.data != null ? this.data.getArguments() : null, elementsInEachRow : 1, elementBuilder : function(i) {
			var tmp17 = _gthis.data.getArguments()[i];
			return _gthis.determineCorrectArgumentWidget(tmp17);
		}, rowBuilder : function(children) {
			return new lib_components_Row({ alignment : lib_components_RowAlignment.Stretch, children : children});
		}})})});
		var tmp18 = lib_utils_Padding.fromTRBL(20.0,0.0,20.0,0.0);
		var tmp19 = lib_utils_Margin.fromTRBL(20.0,0.0,20.0,0.0);
		var tmp20 = new lib_utils_Size({ width : 700, widthType : "px"});
		var this16 = Std.parseInt("0xff" + HxOverrides.substr("#F2F2F2",1,null));
		this.page = new lib_components_Page({ navbar : tmp, route : "/widgets/:category/:id", child : new lib_components_Container({ margin : tmp1, color : tmp2, child : new lib_components_Column({ children : [tmp5,new lib_components_Container({ padding : tmp6, child : new lib_components_Column({ children : [tmp8,tmp10,tmp12,tmp16,new lib_components_Container({ padding : tmp18, margin : tmp19, size : tmp20, color : new lib_utils_Color({ backgroundColor : this16}), child : new lib_components_Column({ padding : lib_utils_Padding.fromTRBL(0.0,0.0,0.0,0.0), children : lib_components_Constructors.constructRows({ data : this.data != null ? this.data.getExample() : null, elementsInEachRow : 1, elementBuilder : function(i1) {
			var tmp21 = _gthis.data.getExample()[i1];
			return _gthis.determineCorrectExampleWidget(tmp21);
