...
var classes_ArgumentDoc = function(name,req) {
	this.name = name;
	this.req = req;
};
...
var classes_ExampleDoc = function(desc,link) {
	this.desc = desc;
	this.link = link;
};
...
lib_core_Navigate.getParameters = function() {
	...
	urlParts.splice(0,1);
	console.log("lib/core/Navigate.hx:52:",routeParts);
	var _g = 0;
	...
	console.log("lib/core/Navigate.hx:58:",params);
	return params;
};
...
pages_SpecificGuidePage.prototype = $extend(lib_core_DynamicComponent.prototype,{
	...
	,getGuides: function() {
		...
		new lib_core_SingleRequest({ url : "http://localhost:3000/api/guides/" + this.id, method : "GET", onComplete : function(res) {
			console.log("src/pages/SpecificGuidePage.hx:64:",res);
			_gthis.setState(_gthis,function() {
				var result = JSON.parse(res.get_content());
				console.log("src/pages/SpecificGuidePage.hx:67:",result);
				...
				console.log("src/pages/SpecificGuidePage.hx:74:",stepsObject);
				_gthis.data = new classes_Guide(result._id,result.title,result.desc,stepsObject);
				console.log("src/pages/SpecificGuidePage.hx:76:",_gthis.data);
			});
		}, onProgress : function() {
			console.log("src/pages/SpecificGuidePage.hx:80:","working");
			_gthis.setState(_gthis,function() {
				_gthis.data = null;
			});
		}}).request();
		...
		if(this.data.getSteps()[i].getFormat() == "header") {
			...
			if(this.data.getSteps()[i].getType() == "break") {
				...
				if(this.data.getSteps()[i].getFormat() == "code") {
					...
					var tmp8 = new lib_utils_Border({ style : lib_utils_BorderStyle.None, cornerRadius : lib_utils_CornerRadius.all(20)});
					var this12 = Std.parseInt("0xff" + HxOverrides.substr("#2e3440",1,null));
					...
					var tmp15 = new lib_utils_Border({ style : lib_utils_BorderStyle.None, cornerRadius : lib_utils_CornerRadius.all(20)});
					var this14 = Std.parseInt("0xff" + HxOverrides.substr("#2e3440",1,null));
...
var pages_WidgetCategoryPage = function() {
	var _g = new haxe_ds_StringMap();
	if(__map_reserved["Layout"] != null) {
		_g.setReserved("Layout","./assets/layout-grid.svg");
	} else {
...
pages_WidgetCategoryPage.__name__ = "pages.WidgetCategoryPage";
pages_WidgetCategoryPage.__super__ = lib_core_DynamicComponent;
pages_WidgetCategoryPage.prototype = $extend(lib_core_DynamicComponent.prototype,{
	init: function() {
		lib_core_DynamicComponent.prototype.init.call(this);
	...
	,getWidgetsUnderCategory: function() {
		...
		new lib_core_SingleRequest({ url : "http://localhost:3000/api/widgets/" + this.category, method : "GET", onComplete : function(res) {
			...
			console.log("src/pages/WidgetCategoryPage.hx:113:","working");
			_gthis.setState(_gthis,function() {
				_gthis.data = null;
			});
		}}).request();
	...
	,component: function() {
		...
		var tmp = new CustomNavbar().navbarComponent();
		var this1 = Std.parseInt("0xff" + HxOverrides.substr("#fafafa",1,null));
		this.page = new lib_components_Page({ navbar : tmp, route : "/widgets/:category", child : new lib_components_Container({ color : new lib_utils_Color({ backgroundColor : this1}), child : new lib_components_Column({ children : lib_components_Constructors.constructRows({ data : this.data, elementsInEachRow : 6, elementBuilder : function(i) {
			return new lib_components_Text(_gthis.data[i].name);
		}, rowBuilder : function(children) {
			return new lib_components_Row({ children : children});
		}})})})});
		return this.page;
