...
Main.main = function() {
	...
	body.font("Lato","100");
	lib_core_Navigate.routes = [new HomePage().component(),new SocketsPage().component(),new WidgetsPage().component(),new DatabasePage().component()];
...
WidgetsPage.prototype = $extend(lib_core_DynamicComponent.prototype,{
	component: function() {
		this.page = new lib_components_Page({ route : "/widgets", child : new lib_components_Request({ url : "http://localhost:3000/widgets", onProgress : function() {
	...
	,isConnectionOpen: function(url) {
		...
		while(_g < _g1) {
			...
			if(this.connections[i].get_url().toString() == url) {
				console.log("lib/core/GlobalState.hx:36:","Found request");
				return true;
			}
		}
		return false;
