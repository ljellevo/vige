...
com_vige_components_Button.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToButton({ widget : button, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
		return button;
	}
...
com_vige_components_Center.prototype = {
	...
	,render: function() {
		...
		case 0:
			...
			new com_vige_support_StyleManager().addStyleToDiv({ widget : parent, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : new com_vige_utils_Size({ width : 100, widthType : "%"}), overflow : this.overflow});
		...
		case 1:
			...
			new com_vige_support_StyleManager().addStyleToDiv({ widget : parent, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : new com_vige_utils_Size({ height : 100, heightType : "%"}), overflow : this.overflow});
			element.appendChild(this.child.render());
...
com_vige_components_Collection.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : container, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
		return container;
	}
...
var com_vige_components_Column = function(arg) {
	...
	this.cellSize = arg.cellSize != null ? arg.cellSize : new com_vige_utils_Size({ width : 100, widthType : "%"});
	...
	this.padding = arg.padding;
	this.margin = arg.margin;
	this.size = arg.size != null ? arg.size : new com_vige_utils_Size({ width : 100, widthType : "%"});
	this.overflow = arg.overflow;
};
...
com_vige_components_Column.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : column, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, mainAxisAlignment : this.mainAxisAlignment, crossAxisAlignment : this.crossAxisAlignment, type : com_vige_support_DivType.Column, overflow : this.overflow});
		var _g = 0;
...
var com_vige_components_Container = function(arg) {
	...
	this.padding = arg.padding;
	this.margin = arg.margin;
	this.size = arg.size != null ? arg.size : new com_vige_utils_Size({ height : 100, heightType : "%", width : 100, widthType : "%"});
	this.overflow = arg.overflow;
};
...
com_vige_components_Embeded.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToEmbeded({ widget : embeded, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size});
		return embeded;
	}
...
com_vige_components_Image.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToImage({ widget : container, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
		return container;
	}
...
com_vige_components_Navbar.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : navbar, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
...
com_vige_components_Page.prototype = {
	...
	,render: function() {
		...
		element.appendChild(this.child.render());
		new com_vige_support_StyleManager().addStyleToDiv({ widget : element, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, overflow : this.overflow});
		return element;
	}
...
com_vige_components_Positioned.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : parent, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : new com_vige_utils_Size({ height : 100, heightType : "%", width : 100, widthType : "%"}), overflow : this.overflow});
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : positioned, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size});
...
com_vige_components_Row.prototype = {
	...
	,render: function() {
		...
		new com_vige_support_StyleManager().addStyleToDiv({ widget : row, color : this.color, border : this.border, padding : this.padding, margin : this.margin, size : this.size, mainAxisAlignment : this.mainAxisAlignment, crossAxisAlignment : this.crossAxisAlignment, type : com_vige_support_DivType.Row, overflow : this.overflow});
		var _g = 0;
		var _g1 = this.children;
		while(_g < _g1.length) {
			var child = _g1[_g];
			...
			new com_vige_support_StyleManager().addStyleToDiv({ widget : rowCell, color : this.cellColor, padding : this.cellPadding, margin : this.cellMargin, size : this.cellSize});
...
var com_vige_components_Text = function(text,arg) {
	...
	this.textAlignment = arg.textAlignment != null ? arg.textAlignment : com_vige_support_TextAlignment.Left;
...
com_vige_core_Navigate.to = function(arg) {
	var url = arg.url;
	if(arg.main == null) {
		arg.main = false;
	}
...
var com_vige_support_TextAlignment = $hxEnums["com.vige.support.TextAlignment"] = { __ename__ : true, __constructs__ : ["Left","Right","Center","Justify","Inherit"]
	,Left: {_hx_index:0,__enum__:"com.vige.support.TextAlignment",toString:$estr}
	,Right: {_hx_index:1,__enum__:"com.vige.support.TextAlignment",toString:$estr}
	,Center: {_hx_index:2,__enum__:"com.vige.support.TextAlignment",toString:$estr}
	,Justify: {_hx_index:3,__enum__:"com.vige.support.TextAlignment",toString:$estr}
	,Inherit: {_hx_index:4,__enum__:"com.vige.support.TextAlignment",toString:$estr}
};
