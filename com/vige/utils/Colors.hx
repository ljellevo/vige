 ...
 */
abstract Colors(Int) from Int to Int {
  /**
   * Predefined color constants for common colors.
   */
  public static inline var TRANSPARENT : Colors = 0x00000000;
  public static inline var BLACK : Colors = 0xff000000;
  public static inline var WHITE : Colors = 0xffffffff;
  public static inline var RED : Colors = 0xffff0000;
  public static inline var GREEN : Colors = 0xff00ff00;
  public static inline var BLUE : Colors = 0xff0000ff;
  public static inline var CYAN : Colors = 0xff00ffff;
  public static inline var MAGENTA : Colors = 0xffff00ff;
  public static inline var YELLOW : Colors = 0xffffff00;
   ...
   */
  @:from public static inline function fromString(rgba : String) : Colors {
    //StringTools.replace(rgba, "#", "0xff");
    return new Colors(Std.parseInt("0xff" + rgba.substr(1)));
  }
   ...
   */
  public static inline function fromRGBAi(r : Int, g : Int, b : Int, a : Int) : Colors {
    return new Colors((r << 16) | (g << 8) | b | (a << 24));
  }
